    ...
    public static function getLibro($id)
    {
        ...
        if ($valid === true || $id == null) {
            $query = "SELECT " . \ConstantesDB\ConsLibrosModel::COD . ","
                ...
                . \ConstantesDB\ConsLibrosModel::EDITORIAL . " FROM " . \ConstantesDB\ConsLibrosModel::TABLE_NAME;
            ...
            $prep_query->bind_result($cod, $titulo, $editorial);
            while ($prep_query->fetch()) {
                $titulo = utf8_encode($titulo);
                $editorial = utf8_encode($editorial);
                $libro = new LibroModel($cod, $titulo, $editorial);
                $listaLibros[] = $libro;
            }
