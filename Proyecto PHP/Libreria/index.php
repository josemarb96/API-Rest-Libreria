...
$query_string = null;
if (isset($_SERVER['QUERY_STRING'])) //Cuando pones la ? te dice el valor de una propiedad de un elemento
{
...
//NOMBRE SERVIDOR/LOQUESEA. pos esto busca que exista ese loqueseaController
